      ...
      <section>
        <div className="product-list-child flex">
          ...
          <div className="product-text-container ff-sanserif">
            <span
              className="fs-overline"
              style={
                currentProduct.new ? { color: "#D87D4A" } : { display: "none" }
              }
            >
              New Product
            </span>
            <h1 className="font-black fs-2 uppercase">{currentProduct.name}</h1>
            <p className="fs-body product-list-description">
            ...
            >
              ${addCommasToPrice(currentProduct.price)}
            </span>

            <div className="flex count-and-cart-container">
              <ItemCounter onValueChange={handleValueChange} />
              <Button1 title="Add to cart" handleClick={addToCart} />
            </div>
          </div>
          {showMessage && (
            <div className="item-added ff-sanserif">
          ...
          <div className="in-the-box-container">
            ...
            <div>
              {currentProduct.includes.map((part, index) => {
                return (
                  <p className="fs-body flex" key={index + 1}>
                    <span style={{ color: "#D87D4A", marginRight: "1.5rem" }}>
                      {part.quantity}x
                    </span>
                    {part.item}
                  </p>
        ...
        <div className="others-parent">
          <h1 className="fs-3 font-black uppercase ff-sanserif">
            You may also like
          </h1>
          <div id="others">
              ...
              <div>
                <img
                  src={
                    ...
                    screenSize +
                    "/image-" +
                    currentProduct.others[0].slug +
                    ".jpg"
                  }
                />
              </div>

              <h1 className="fs-5 ff-sanserif font-black uppercase">
                {currentProduct.others[0].name}
              </h1>
