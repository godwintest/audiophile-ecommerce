...
export default function Checkout() {
  ...
  const { cartData, updateCartData, updateCartItemQuantity, clearCart } =
      ...
      <main style={{ backgroundColor: "#F1F1F1" }}>
        <form id="form-main" onSubmit={handleSubmit} action="/">
          <div id="form-container" className="ff-sanserif">
            ...
            <h1 className="ff-sanserif uppercase fs-subtitle checkout-section-title">
              Billing Details
            </h1>
            ...
            <section className="form-section">
              <div className="label-input-container ff-sanserif radio-container-parent">
                <h1 className="font-black">Payment Method</h1>
              ...
              <div
                className="form-payment-container"
                style={
        ...
        <div id="order-confirmation-parent">
          {!processing ? (
            <OrderConfirmation
              imgSrc={
                !(cartData[0] == null) &&
                "./cart/image-" + cartData[0].currentProduct.slug + ".jpg"
              }
            ...
            <div className="spinner-container">
              <Spinner speed="1.0s" />
              <div className="processing ff-sanserif">
                {" "}
