    ...
    <>
      <div id="front-page-feature">
        <div className="front-page-text-container ff-sanserif flex">
          <h1
            className="fs-overline uppercase font-white new-product-home"
            style={{ opacity: "0.5" }}
          >
            <span></span>
            New Product
          ...
          <p className="font-white fs-body" style={{ opacity: "0.5" }}>
      ...
      <section id="showcase-feature" className="ff-sanserif">
        <div id="showcase-zx9">
          ...
          <div className="showcase-text-container1">
            ...
            <p className="fs-body font-white" style={{ opacity: "0.75" }}>
              Upgrade to premium speakers that are phenomenally built to deliver
              truly remarkable sound.
            </p>
            <Link to="speakers/zx9-speaker">
              <Button2 title="see product" />
            </Link>
          </div>
        </div>
